...
description: Keep the shared music_theory.hpp implementation synchronized between mnxdom and musxdom.
---

# Music theory synchronization

`src/music_theory/music_theory.hpp` is shared by mnxdom and musxdom. Any change
